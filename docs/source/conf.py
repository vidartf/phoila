...
# -*- coding: utf-8 -*-
#
# phoila documentation build configuration file
#
...
_version_py = os.path.join(repo, 'phoila', '_version.py')
version_ns = {}
...
latex_documents = [
    (master_doc, 'phoila.tex', 'phoila Documentation',
